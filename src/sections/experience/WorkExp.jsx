...
function WorkExp() {
  return (
    ...
    >
      <div className="flex w-full max-w-[1300px] flex-col space-y-5 overflow-clip bg-[url('/assets/experience.svg')] bg-[length:90px_auto] bg-[position:top_right] bg-no-repeat text-white md:space-y-10 md:bg-[length:120px_auto] md:bg-[position:35%_0%] md:px-20 md:py-7">
