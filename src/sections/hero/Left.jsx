  ...
  return (
    <div className="mt-5 flex max-h-1/2 flex-col space-y-4 md:mt-0 md:h-full md:max-h-full md:w-1/2 md:space-y-8 md:pt-10">
      <div className="bg-primary-blue-100 flex w-30 items-center justify-center space-x-2 rounded-full py-2 md:w-45 md:text-xs">
        ...
        <p className="text-primary-blue h-2 text-[7px] font-semibold uppercase md:h-3.5 md:text-xs">
          Available For work
        </p>
      </div>
      <div className="w-full space-y-4 md:w-100 md:space-y-8">
        <p className="w-70 text-4xl font-bold md:w-full md:text-5xl">
          Hi, I'm Solomon Great{" "}
          <span className="relative">
            <span className="text-primary-blue">I'm a Visual</span>
            <svg
              className="absolute top-8 right-0 w-2/4 md:top-11"
        ...
        <p className="w-70 text-xs md:w-90 md:text-sm">
